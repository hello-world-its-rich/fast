...
<form class="w-full max-w-sm flex mb-20 items-center justify-center" name="richlandingpage" method="POST" data-netlify="true">
  <div class="flex items-center border-b border-teal-500 py-2 justify-center">
    <input class="flex items-center appearance-none bg-transparent border-none w-full text-gray-700 mr-3 py-1 px-2 leading-tight focus:outline-none" type="text" placeholder="Leave a message...." name="message" aria-label="Full name">
